...
export default function SignInScreen() {
  ...
  return (
    ...
    >
      {/* decorative elements */}
      <View className="absolute -left-16 top-12 h-56 w-56 rounded-full bg-background/10 dark:bg-background/40" />
      <View className="absolute right-[-74px] top-40 h-72 w-72 rounded-full bg-background/5 dark:bg-background/35" />
      {/* Image */}
